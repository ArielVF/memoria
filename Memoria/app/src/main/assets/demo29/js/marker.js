...
function Marker(poiData) {
    ...
    */
    ...
    this.markerDrawableSelected = new AR.ImageDrawable(World.markerDrawableSelected, 3.5, {
        zOrder: 1,
        opacity: 0.0,
        onClick: null
    });
    ...
    this.titleLabel = new AR.Label(poiData.title.trunc(100), 0.6, {
        zOrder: 1,
        translate: {
            y: 2.1
        },
    ...
    this.descriptionLabel = new AR.Label(poiData.description.trunc(20), 0.4, {
        zOrder: 1,
        translate: {
            y: -2
        },
        style: {
            textColor: '#FFFFFF',
            fontStyle: AR.CONST.FONT_STYLE.ITALIC
        }
    });
